...
/* set to 1 to force generic implemetation as default even on ARM platform */
#define FIRFILTER_FORCE_GENERIC 0
 ...
 * if both parameters are 0, does NOT allocate any memory and intead
